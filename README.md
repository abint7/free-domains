...
<!-- START LIST -->
 ...
 | [domain.dee.al](https://domain.dee.al/) | dee.al is a free identity for developers on the web. This service offers a handy subdomain service for you to have a subdomain like `foo.dee.al` or `bar.dee.al` for use on your static sites via CNAME DNS record. | [dee-al/domain.dee.al](https://github.com/dee-al/domain.dee.al) | ✅ | 
